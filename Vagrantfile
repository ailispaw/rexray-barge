...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision :shell do |sh|
    sh.inline = <<-EOT
      # Install REX-Ray
      wget -qO- https://dl.bintray.com/rexray/rexray/stable/#{REXRAY_VERSION}/rexray-Linux-x86_64-#{REXRAY_VERSION}.tar.gz | \
        tar zxf - -C /opt/bin
      ...
      /etc/init.d/docker restart v17.12.0-ce
    EOT
  end
